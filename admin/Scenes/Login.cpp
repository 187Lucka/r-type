...
LoginScene::LoginScene(SceneManager& sceneManager, FontLoader& fontLoader) 
    : Scene(sceneManager, fontLoader), 
        usernameField(sf::Vector2f(1920 / 2, 1080 / 2 - 50), sf::Vector2f(400, 50), fontLoader.getFont("VerminVibes1989Regular-m77m.ttf", "admin/Stream/VerminVibes1989Regular-m77m.ttf"), sceneManager.i18n_.get("username")), 
        passwordField(sf::Vector2f(1920 / 2, 1080 / 2 + 50), sf::Vector2f(400, 50), fontLoader.getFont("VerminVibes1989Regular-m77m.ttf", "admin/Stream/VerminVibes1989Regular-m77m.ttf"), sceneManager.i18n_.get("password")),
